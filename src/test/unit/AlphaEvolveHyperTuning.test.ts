...
describe('AlphaEvolve Hyperparameter Tuning', () => {
  it('should maintain stable parameters over 1000 generations with a low mutation rate', () => {
    let params: import("../../logic/Types").AgentParameters = { generation: 1, analyticalDepth: 0.5, responsiveness: 0.5 };
  ...
  it('should show higher variance with a higher mutation rate', () => {
    ...
    for (let run = 0; run < 10; run++) {
      let paramsHigh: import("../../logic/Types").AgentParameters = { generation: 1, analyticalDepth: 0.5, responsiveness: 0.5 };
      let paramsLow: import("../../logic/Types").AgentParameters = { generation: 1, analyticalDepth: 0.5, responsiveness: 0.5 };
