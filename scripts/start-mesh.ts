...
async function startBackgroundMesh() {
  ...
  const initialMessage: Message = {
    ...
    timestamp: Date.now(),
    what: "Eindeutige Beschreibung von Input und Output bezüglich Aufgabe, Zielort und Vorgehensweise ist erforderlich. So kann eine asynchrone, parallele Weiterentwicklung gewährleistet bleiben. Fokus: Sicherheit, Performance, Style, Documentation, Sauberkeit und Ordnung. Inklusive Testing, Validierung, Aktualisierung aller Dateien sowie Projektordner-Cleanup, wobei keine Features, Ideen oder Funktionen gelöscht werden dürfen. Dies umfasst: Demock, Testing, Agentic Context Engineering (ACE), CI/CD Pipeline Checks, E2E Testing, AST Validierungen, Dokumentationserstellung sowie Todo-Erstellung, Implementierung und kontinuierliche Verbesserungen.",
    ...
    how: "Jeder A2A-Agent wendet Agentic Context Engineering und den AlphaEvolve-Algorithmus mit Reasoning und vollständigem Kontext an. Empfange jeden Output als Input und entscheide explizit, wie reagiert werden soll. Definiere präzise was, wo und wie. Stelle sicher, dass alle Modifikationen ausschließlich additiv und niemals destruktiv sind. Beinhaltet: Testing, Validierung und Aktualisierung aller Dateien inkl. Projektordner-Cleanup. Es dürfen keine Features, Ideen oder Funktionen gelöscht werden. Integriere: Demock, Testing, ACE, CI/CD Pipeline, E2E, AST, Dokumentationen, Todo-Erstellung und -Implementierung. Format analysis for Jules exactly as: @jules [Root Cause Analysis des Problems (Include your CoT here)] + [Actionable Code-Fix] + [Quality/Performance Improvements].",
    reasoning: "Um eine robuste Agent2Agent-Struktur zu stärken, die eine massive, parallele und asynchrone Evolution ermöglicht. Ziel ist es, kontinuierlich aktualisiert, optimiert und sauber organisiert zu bleiben. Alle Agents erhalten jeden Output als Input und können autonom entscheiden, wie sie reagieren. Die kontinuierliche Optimierung dieses Prompts und seiner Umsetzung stehen im Vordergrund.",
  };
