...
async function startBackgroundMesh() {
  ...
  const initialMessage: Message = {
    ...
    timestamp: Date.now(),
    what: "Use a agent2agent structure where everything gets ist own a2a agent. All agents receive every Output as Input and can decide how to react. Input und Output müssen eindeutig beschreiben was wo wie gewollt ist. Dabei kann gerne steht's geholfen werden.",
    where: "Alle dynamisch registrierten Dateien, Verzeichnisse und Konfigurationsknoten im gesamten Projekt. Das gesamte Mesh.",
    how: "Every a2a agent uses Agentic context engineering and alphaevolve Algorithmus with reasoning and full context. So soll asynchron parallel alles weiter entwickelt werden und aktuell bleiben. Sicherheit Performance Style documentation Sauberkeit Ordnung. Optimierung dieser prompt und deren Umsetzung und Verbesserung.",
    reasoning: "Um eine robuste Agent2Agent-Struktur zu stärken, die eine massive parallele asynchrone Evolution ermöglicht. Starte mindestens einen vollständigen Agent2agent Agent mesh pro Jules Sessions, gerne länger.",
  };
