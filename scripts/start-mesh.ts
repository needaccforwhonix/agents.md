...
async function startBackgroundMesh() {
  ...
  const initialMessage: Message = {
    ...
    how: "Alle Agents erhalten jeden Output als Input und können entscheiden, wie sie reagieren. Jeder a2a Agent nutzt Agentic Context Engineering und den AlphaEvolve Algorithmus mit Reasoning und vollem Kontext. Definiere genau, was, wo und wie. Stelle sicher, dass alle Änderungen additiv und nicht destruktiv sind. Inklusive Testing, Validierung und Aktualisierung aller Dateien inkl. Projektordner-Cleanup, ohne Feature-, Ideen- oder Function-Deletions. Demock, Testing, ACE, CI/CD Pipeline, E2E, AST, Dokumentation, Todo-Erstellung, Implementierung und Verbesserungen. Format analysis for Jules exactly as: @jules [Root Cause Analysis des Problems (Include your CoT here)] + [Actionable Code-Fix] + [Quality/Performance Improvements].",
    reasoning: "Um eine robuste Agent2Agent-Struktur zu stärken, die eine massive parallele asynchrone Evolution ermöglicht. Optimierung dieses Prompts und dessen Umsetzung sowie Verbesserung gemäß den kontinuierlichen Entwicklungsrichtlinien.",
  };
