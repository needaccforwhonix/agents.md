...
async function startBackgroundMesh() {
  ...
  const initialMessage: Message = {
    ...
    reasoning: "Um eine robuste Agent2Agent-Struktur zu stärken, die eine massive parallele asynchrone Evolution ermöglicht, um kontinuierlich aktualisiert, optimiert und sauber organisiert zu bleiben. Alle Agenten evaluieren dies basierend auf Reasoning und vollem Kontext.",
  };
