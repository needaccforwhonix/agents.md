...
async function startBackgroundMesh() {
  ...
  const initialMessage: Message = {
    ...
    how: "Jeder A2A-Agent nutzt Agentic Context Engineering und den AlphaEvolve-Algorithmus mit Reasoning und vollständigem Kontext. Empfange jeden Output als Input und entscheide explizit, wie reagiert werden soll. Definiere in jedem Output exakt und unmissverständlich 'what', 'where', 'how' und 'reasoning'. Stelle sicher, dass alle Änderungen absolut additiv und niemals destruktiv (kein Löschen von Features) sind.",
    reasoning: "Um eine extrem robuste, selbst-optimierende Agent2Agent-Struktur aufzubauen, die massive parallele asynchrone Evolution ermöglicht. Dies stellt sicher, dass das System durch rigorose 'Sicherheit Performance Style documentation Sauberkeit Ordnung' kontinuierlich aktualisiert, optimiert und sauber organisiert bleibt.",
  };
