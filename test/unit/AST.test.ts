...
describe('AST Demock Validation', () => {
  ...
  it('should issue a warning for code containing console.log without invalidating', () => {
  ...
  it('should issue a warning for code containing TODO string without invalidating', () => {
