...
describe('AST Demock Validation', () => {
  ...
  it('should warn code containing console.log without invalidating it completely by default (errors remain 0)', () => {
  ...
  it('should warn code containing TODO string without invalidating it completely by default', () => {
