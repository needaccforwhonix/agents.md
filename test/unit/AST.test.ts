...
describe('AST Demock Validation', () => {
  ...
  it('should not invalidate code containing console.log but generate a warning', () => {
  ...
  it('should not invalidate code containing TODO string but generate a warning', () => {
